...
function NgProgressBarComponent_div_0_div_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "div", 5);
} if (rf & 2) {
    const state_r1 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngStyle", state_r1.meteorStyles);
} }
function NgProgressBarComponent_div_0_div_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "div");
    ɵngcc0.ɵɵelement(1, "div", 6);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const state_r1 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMapInterpolate1("spinner ", state_r1.spinnerClasses, "");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", state_r1.spinnerStyles);
} }
function NgProgressBarComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "div", 1);
    ɵngcc0.ɵɵelementStart(1, "div", 2);
    ɵngcc0.ɵɵtemplate(2, NgProgressBarComponent_div_0_div_2_Template, 1, 1, "div", 3);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵtemplate(3, NgProgressBarComponent_div_0_div_3_Template, 2, 4, "div", 4);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const state_r1 = ctx.$implicit;
    const ctx_r0 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", state_r1.containerClasses);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", state_r1.progressStyles);
    ɵngcc0.ɵɵadvance(1);
...
NgProgress.ɵfac = function NgProgress_Factory(t) { return new (t || NgProgress)(); };
NgProgress.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NgProgress, factory: NgProgress.ɵfac });
/** @nocollapse */
...
NgProgressBarComponent.ɵfac = function NgProgressBarComponent_Factory(t) { return new (t || NgProgressBarComponent)(ɵngcc0.ɵɵdirectiveInject(NgProgress)); };
NgProgressBarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgProgressBarComponent, selectors: [["ng-progress-bar"]], inputs: { ease: "ease", speed: "speed", meteor: "meteor", spinner: "spinner", spinnerPosition: "spinnerPosition", direction: "direction", thick: "thick", color: "color" }, decls: 2, vars: 3, consts: [["class", "ng-progress", 3, "ngClass", 4, "ngIf"], [1, "ng-progress", 3, "ngClass"], [1, "bar", 3, "ngStyle"], ["class", "meteor", 3, "ngStyle", 4, "ngIf"], [3, "class", 4, "ngIf"], [1, "meteor", 3, "ngStyle"], [1, "spinner-icon", 3, "ngStyle"]], template: function NgProgressBarComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, NgProgressBarComponent_div_0_Template, 4, 4, "div", 0);
        ɵngcc0.ɵɵpipe(1, "async");
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngIf", ɵngcc0.ɵɵpipeBind1(1, 1, ctx.state$));
    } }, directives: [ɵngcc1.NgIf, ɵngcc1.NgClass, ɵngcc1.NgStyle], pipes: [ɵngcc1.AsyncPipe], styles: [".ng-progress[_ngcontent-%COMP%] {\n  z-index: 999999;\n  top: 0;\n  left: 0;\n  width: 100%;\n  position: fixed;\n  zoom: 1;\n  filter: alpha(opacity=0);\n  opacity: 0;\n  -webkit-transition: opacity 200ms linear;\n  transition: opacity 200ms linear; }\n\n.active[_ngcontent-%COMP%] {\n  filter: alpha(opacity=100);\n  opacity: 1;\n  -webkit-transition: none;\n  transition: none; }\n\n.bar[_ngcontent-%COMP%] {\n  position: absolute;\n  width: 100%;\n  height: 2px; }\n\n.thick[_ngcontent-%COMP%]   .bar[_ngcontent-%COMP%] {\n  height: 3px; }\n\n.meteor[_ngcontent-%COMP%] {\n  display: block;\n  position: absolute;\n  right: 0;\n  top: -3px;\n  width: 100px;\n  height: 100%;\n  opacity: 1.0; }\n\n.thick[_ngcontent-%COMP%]   .meteor[_ngcontent-%COMP%] {\n  top: -4px; }\n\n.thick[_ngcontent-%COMP%]   .spinner-icon[_ngcontent-%COMP%] {\n  width: 24px;\n  height: 24px;\n  border: solid 3px transparent; }\n\n.spinner[_ngcontent-%COMP%] {\n  display: block;\n  position: fixed;\n  z-index: 1031;\n  top: 15px;\n  right: 15px; }\n  .spinner.spinner-left[_ngcontent-%COMP%] {\n    left: 15px;\n    right: unset; }\n\n.spinner-icon[_ngcontent-%COMP%] {\n  width: 18px;\n  height: 18px;\n  -webkit-box-sizing: border-box;\n          box-sizing: border-box;\n  border: solid 2px transparent;\n  border-radius: 50%;\n  -webkit-animation: nprogress-spinner 400ms linear infinite;\n          animation: nprogress-spinner 400ms linear infinite; }\n\n.anti-clockwise[_ngcontent-%COMP%]   .spinner-icon[_ngcontent-%COMP%] {\n  animation-direction: reverse; }\n\n@-webkit-keyframes nprogress-spinner {\n  0% {\n    -webkit-transform: rotate(0deg);\n            transform: rotate(0deg); }\n  100% {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg); } }\n\n@keyframes nprogress-spinner {\n  0% {\n    -webkit-transform: rotate(0deg);\n            transform: rotate(0deg); }\n  100% {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg); } }"], changeDetection: 0 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgProgressBarComponent, [{
        type: Component,
        args: [{
...
`],
    ...
    }], function () { return [{ type: NgProgress }]; }, { ease: [{
            type: Input
        }], speed: [{
            type: Input
        }], meteor: [{
...
NgProgressComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgProgressComponent, selectors: [["ng-progress"]], inputs: { ease: "ease", meteor: "meteor", spinner: "spinner", spinnerPosition: "spinnerPosition", direction: "direction", color: "color", thick: "thick", maximum: "maximum", minimum: "minimum", speed: "speed", trickleSpeed: "trickleSpeed", toggleProgressbar: ["toggle", "toggleProgressbar"] }, features: [ɵngcc0.ɵɵNgOnChangesFeature], decls: 1, vars: 8, consts: [[3, "speed", "ease", "meteor", "spinner", "spinnerPosition", "direction", "color", "thick"]], template: function NgProgressComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "ng-progress-bar", 0);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("speed", ctx.speed)("ease", ctx.ease)("meteor", ctx.meteor)("spinner", ctx.spinner)("spinnerPosition", ctx.spinnerPosition)("direction", ctx.direction)("color", ctx.color)("thick", ctx.thick);
    } }, directives: [NgProgressBarComponent], styles: ["[_nghost-%COMP%] {\n  z-index: 999999;\n  pointer-events: none;\n  position: relative; }"], changeDetection: 0 });
/** @nocollapse */
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgProgressModule, { declarations: function () { return [NgProgressComponent, NgProgressBarComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [NgProgressComponent]; } }); })();
